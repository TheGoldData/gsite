...
s[0]='gsp'
def baseDir=binding.getProperty('baseDir')
Collection<File> list=FileUtils.listFiles(new File(baseDir),s,true);
...
s2[0]='gsp'
Collection<File> gspList=FileUtils.listFiles(new File(baseDir+'/tpls'),s2,true);
